...
public class CameraCtrl : MonoBehaviour
{
    ...
    [SerializeField] private Transform k_DeadCampoint = null;
    ...
    private void FixedUpdate()
    {
        ...
        if (manager.GetIsDead())
        {
            ...
            deadCam.transform.SetPositionAndRotation(k_DeadCampoint.position, k_DeadCampoint.rotation);
            return;
        }
    ...
    public void EnableDeadCamera()
    {
        ...
        k_Collider.transform.up = (manager.transform.forward * -1);
    ...
    private void HandleRotation()
    {
        ...
        if (InputManager.Instance.IsAimJoystickBtnPressed && InputManager.Instance.Type == InputManager.InputType.Mobile)
        {
            ...
            {
                targetRot.x -= Mathf.RoundToInt(InputManager.Instance.AimJoystick.Direction.y);
                targetRot.y += Mathf.RoundToInt(InputManager.Instance.AimJoystick.Direction.x);
            }
        }
